...
$ssl_cert_path = '/var/www/html/us-east-1-bundle.pem'; // Path to the downloaded SSL certificate
...
$con = new mysqli($servername, $username, $password, $dbname, 3306, null, MYSQLI_CLIENT_SSL);
